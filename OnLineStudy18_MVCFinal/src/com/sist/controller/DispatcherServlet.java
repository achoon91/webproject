 ...
 * 	C = Controller => Model을 연결해서 결과값을 가지고 온 후에 JSP 결과값을 전송
 * 
 ...
 * 		request에 첨부
 * 		============
 * 		request.setAttribute() =========> Controller =========> 해당 JSP 전송 ========> JSP에는 request에 있는 데이터 출력
 * 											해당 JSP에 request
 ...
 * 
 * 		Controller : Model에 있는 메소드 찾기 ==> 실행  ==> 메소드실행결과를 JSP로 전송
 * 					==================
...
import org.w3c.dom.*;
//C:\\Users\\achoo\\eclipse-workspace\\OnLineStudy18_MVCFinal\\src
public class DispatcherServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			// new MainModel() ==> Controller (한개) ==> 공유(수정을 하면) => 유지보수가 어렵다)
